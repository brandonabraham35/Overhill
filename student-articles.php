  ...
  <section class="section"><div class="container">
    <div class="content-layout with-sidebar">
      <div class="content-main">
        <p class="lead">Creative writing, poems and stories by our talented pupils.</p><?php display_content('student_articles'); ?><div class="news-grid"><article class="news-card"><div class="news-body"><h3><?php display_content('article_title_1'); ?></h3><p class="muted">By <?php display_content('article_author_1'); ?></p><p><?php display_content('article_excerpt_1'); ?></p><a href="#">Read more &rarr;</a></div></article><article class="news-card"><div class="news-body"><h3><?php display_content('article_title_2'); ?></h3><p class="muted">By <?php display_content('article_author_2'); ?></p><p><?php display_content('article_excerpt_2'); ?></p><a href="#">Read more &rarr;</a></div></article><article class="news-card"><div class="news-body"><h3><?php display_content('article_title_3'); ?></h3><p class="muted">By <?php display_content('article_author_3'); ?></p><p><?php display_content('article_excerpt_3'); ?></p><a href="#">Read more &rarr;</a></div></article></div>
      </div>
