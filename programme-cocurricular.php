<?php
$pageTitle = '<?php display_content('quick_card_3_title'); ?> Activities';
$current = 'programme-cocurricular.php';
include 'includes/public_header.php';
?>

  <section class="page-banner">
    <div class="container">
      <h1><?php display_content('quick_card_3_title'); ?> Activities</h1>
      <p class="breadcrumb"><a href="index.php">Home</a> &raquo; <?php display_content('quick_card_3_title'); ?> Activities</p>
    </div>
  </section>
  <section class="section"><div class="container">
    <div class="content-layout with-sidebar">
      <div class="content-main">
        <div class="img-frame wide"><img src="images/hero3.jpg" alt="<?php display_content('quick_card_3_title'); ?> Activities"></div><p class="lead">Clubs, music, drama, art and more to develop the whole child.</p><p>This programme is part of our commitment to holistic education that develops the whole child &mdash; academically, socially, physically and creatively.</p><div class="cms-placeholder"><span class="cms-tag"><?php display_content('programme_cocurricular_content'); ?></span><p>This content area will be populated from the admin dashboard / CMS.</p></div><div class="card-grid"><div class="info-card"><div class="card-icon">&#10003;</div><h3>Age Appropriate</h3><p>Tailored for nursery and primary learners.</p></div><div class="info-card"><div class="card-icon">&#10003;</div><h3>Expert Guidance</h3><p>Led by trained, caring teachers.</p></div><div class="info-card"><div class="card-icon">&#10003;</div><h3>Fun & Engaging</h3><p>Learning through play and discovery.</p></div></div>
      </div>

        <aside class="sidebar">
          <h3>In This Section</h3>
          <ul class="side-nav"><li class=""><a href="programme-computer.php">Computer Lessons</a></li><li class=""><a href="programme-reading.php">Reading Programme</a></li><li class=""><a href="programme-handwriting.php">Handwriting Programme</a></li><li class=""><a href="programme-games.php">Games and Sports</a></li><li class=""><a href="programme-vocational.php">Vocational Skills</a></li><li class=""><a href="programme-daycare.php">Day Care</a></li><li class="active"><a href="programme-cocurricular.php"><?php display_content('quick_card_3_title'); ?> Activities</a></li></ul>
          <div class="side-cta">
            <h4>Ready to Join?</h4>
