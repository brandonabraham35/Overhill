  ...
  <section class="section"><div class="container">
    <div class="content-layout with-sidebar">
      <div class="content-main">
        ...
        <div class="person-grid" id="leadershipList">
        ...
        <aside class="sidebar">
          ...
          <ul class="side-nav"><li class=""><a href="school-history.php">School History</a></li><li class=""><a href="vision-mission.php">Vision & Mission</a></li><li class=""><a href="core-values.php">Core Values</a></li><li class=""><a href="proprietor-message.php">Proprietor's Message</a></li><li class=""><a href="chairman-message.php">Chairman's Message</a></li><li class=""><a href="headteacher-message.php">Headteacher's Message</a></li><li class="active"><a href="leadership-team.php">Leadership Team</a></li><li class=""><a href="staff-directory.php">Staff Directory</a></li></ul>
          <div class="side-cta">
            <h4>Ready to Join?</h4>
