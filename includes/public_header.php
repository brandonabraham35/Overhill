  ...
  <header class="site-header" id="mainHeader">
    <div class="container header-inner">
      <a href="index.php" class="brand">
        <img src="<?= e(get_setting('site_logo', 'images/logo.jpeg')) ?>" alt="Logo" class="brand-logo">
        <div class="brand-text">
          <span class="brand-name"><?= e(get_setting('school_name', 'Overhill Junior School')) ?></span>
          <span class="brand-motto"><?= e(get_setting('motto', 'Knowledge Is Power')) ?></span>
        </div>
      </a>
